...
import com.garg.vivek.FileUploader.models.enums.EmailTemplateName;
...
import com.garg.vivek.FileUploader.repositories.TokenRepo;
...
public class AuthenticationService {
  ...
  public void register(@RequestBody @Valid RegistrationRequest registrationRequest) throws MessagingException {
    ...
    if (userRepo.findByEmail(registrationRequest.getEmail()).isPresent()) throw new IllegalArgumentException("Already a user Exists");
